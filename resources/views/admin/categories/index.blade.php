...
<header class="px-6 py-4 space-y-2 text-center">
       <h1 class="font-serif text-3xl text-sky-600 dark:text-sky-500">Bienvenido al panel administrativo de las categories</h1>
...
<main class="grid w-full gap-4 px-4 max-w-7xl sm:grid-cols-2 md:grid-cols-3">
    @foreach ($categories as $item)
        ...
        <div class="max-w-3xl px-4 py-2 space-y-4 bg-white rounded shadow dark:bg-slate-800">
            <h4 class="text-xl text-slate-600 dark:text-slate-300 hover:underline">
            ...
            <div class="flex justify-between">
                ...
                <a class="inline-flex items-center text-xs font-semibold tracking-widest text-center uppercase transition duration-150 ease-in-out dark:text-slate-400 text-green-500 hover:text-slate-600 dark:hover:text-slate-500 focus:outline-none focus:border-slate-200" href="{{route('categories.show', $item)}}">Ver</a>
